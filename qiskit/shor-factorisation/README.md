...
Here, we’ll use Qiskit’s built-in simulation of Shor’s algorithm to factor small integers such as `15`, since simulating large quantum circuits is computationally expensive.
